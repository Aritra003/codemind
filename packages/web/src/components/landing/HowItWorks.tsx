...
const STEPS = [
  { num: "01", Icon: Download, color: "#4361EE",
    ...
    body: "Run npx codemind in any git repo. tree-sitter parses TypeScript, JavaScript, and more. No API key. No account. No cloud. Your data never leaves your machine.",
    cmd: "npx codemind",
  ...
  { num: "03", Icon: Rocket, color: "#00F5D4",
    ...
    body: "Run codemind watch for real-time blast radius on every save. Add codemind serve to your Claude Code MCP settings and your AI agent will check before every edit.",
    cmd: "codemind serve",
